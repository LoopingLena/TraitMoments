...
A function to visualise trait distributions based on moments is not yet available in ‘TraitMoments’, but I intend to implement it in later versions. Here I show how to visualise trait distributions for single communities using the package 'PearsonDS' that can be installed from CRAN. Lets plot the distributions of Trait 1 for Community 1, 5 and 9:
